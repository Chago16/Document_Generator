<script lang="ts">
	...
	async function loginUser() {
        ...
        const data = await response.json();
				...
				goto('/main'); // Redirect to the main page
			} else {
...
<div class="banner-login-wrapper">
	<div class="banner-wrapper">
		...
		<div class="tagline">
			<h3>
				An AI-Powered Document Generation Platform for Enhanced Productivity and Personalized
				Automation
			</h3>
		</div>
	</div>
					...
					<div class="register-input">
						...
						<div class="login-link">
							<div class="login-link-text">
								<h3>
									Already have an account? <a href="#" on:click={hideRegisterScreenLink}>Log in</a>
								</h3>
							</div>
						</div>
					</div>
