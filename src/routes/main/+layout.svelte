		...
		<div class="create-account">
			<div class="create" on:click={goToTemplates}>
				<div class="create-contents">
					...
					>
						<path
							d="M23 15.3333V30.6666M15.3333 23H30.6667M42.1667 23C42.1667 33.5854 33.5855 42.1666 23 42.1666C12.4146 42.1666 3.83334 33.5854 3.83334 23C3.83334 12.4145 12.4146 3.83331 23 3.83331C33.5855 3.83331 42.1667 12.4145 42.1667 23Z"
							stroke="#EEF2F8"
							stroke-width="4"
	...
	<div class="wrapper-container">
		...
		<div class="navigation-container">
			...
			<div id="navigation-bar" class:inactive={!navbarActive}>
				...
				>
					<path
						d="M0.000137329 0L134 27.5C170.5 36 183 65.8858 183 93.5V484H0.000137329V0Z"
						fill="#023DFE"
					/>
					<path
						d="M-1.52588e-05 835L134 807.5C170.5 799 183 769.114 183 741.5V351H-1.52588e-05V835Z"
						fill="#023DFE"
					/>
				</svg>
			</div>
			...
			>
				...
				>
					<path
						d="M165 0C165 25.4313 165 37.7558 143.348 40.0543C121.696 42.3528 46.4535 48.1901 46.4535 48.1901C0 52.1342 0.254927 68.8873 0 87.614V107.542L165 107.542V0Z"
						fill="white"
					/>
					<path
						d="M165 199C164.993 171.661 165.071 156.502 143.423 153.859C121.775 151.217 46.4535 142.2 46.4535 142.2C0 136.057 0.254927 121.503 0 102.776V82.8485H164.971L165 199Z"
						fill="white"
					/>
				</svg>
			</div>
				...
				<nav>
					<ul>
						<li>
							...
							<a
								href="/main"
								on:click={() => activePage.set('home')}
								class={$activePage === 'home' ? 'activePage' : ''}
							>
								<!-- svelte-ignore a11y_no_static_element_interactions -->
								<span
									class="navigation-item"
									class:inactive-item={!navbarActive}
						...
						<li>
							...
							<a
								href="/main/templates"
								on:click={() => activePage.set('templates')}
								class={$activePage === 'templates' ? 'activePage' : ''}
							>
								<!-- svelte-ignore a11y_no_static_element_interactions -->
								<!-- svelte-ignore event_directive_deprecated -->
								<span
						...
						<li>
							...
							<a
								href="/main/mydocs"
								on:click={() => activePage.set('mydocs')}
								class={$activePage === 'mydocs' ? 'activePage' : ''}
							>
								<!-- svelte-ignore a11y_no_static_element_interactions -->
								<!-- svelte-ignore event_directive_deprecated -->
								<span
						...
						<li>
							...
							<a
								href="/main/details"
								on:click={() => activePage.set('details')}
								class={$activePage === 'details' ? 'activePage' : ''}
							>
								<!-- svelte-ignore a11y_no_static_element_interactions -->
								<!-- svelte-ignore event_directive_deprecated -->
								<span
									...
									>
										<g clip-path="url(#clip0_104_200)">
											<path
												...
												fill-rule="evenodd"
												clip-rule="evenodd"
												d="M14.9553 25H2.67857C1.19924 25 0 23.8007 0 22.3214V2.67857C0 1.19924 1.19924 0 2.67857 0H22.3214C23.8007 0 25 1.19924 25 2.67857V14.9545H16.0714C15.455 14.9545 14.9553 15.4542 14.9553 16.0706V25ZM17.1874 23.8839L23.8848 17.1866H17.1874V23.8839Z"
												fill="#1B1B1B"
											/>
										</g>
										<defs>
						...
						<li>
							...
							<a
								href="/main/contact"
								on:click={() => activePage.set('contact')}
								class={$activePage === 'contact' ? 'activePage' : ''}
							>
								<!-- svelte-ignore a11y_no_static_element_interactions -->
								<!-- svelte-ignore event_directive_deprecated -->
								<span
						...
						<li>
							...
							<a
								href="/main/about"
								on:click={() => activePage.set('about')}
								class={$activePage === 'about' ? 'activePage' : ''}
							>
								<!-- svelte-ignore a11y_no_static_element_interactions -->
								<!-- svelte-ignore event_directive_deprecated -->
								<span
			...
			<!-- Nav Bar Contents Closing Div -->
		</div>
		<!-- Nav Bar Container Closing Div -->
	</div>
	<!-- Wrapper Container Closing Div -->
</main>
